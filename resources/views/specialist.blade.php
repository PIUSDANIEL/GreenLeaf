...
<body class="hold-transition sidebar-mini bg-light" >
    <div class="col-12 " style="background-color:#00dfff;">
  ...
  <nav class="main-header navbar navbar-expand  navbar-light"   style="background-color:rgb(236, 243, 243)">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      {{-- <li class="nav-item dropdown">
        ...
        <li class="nav-item dropdown">
              <a href="{{ route('specialist.logout') }}" onclick="event.preventDefault();document.getElementById('logout-form').submit();"
              class="nav-link dashbordhome" style="color:darkblue;">
                Logout </a>
                    <form action="{{ route('specialist.logout') }}" method="POST" class="d-none" id="logout-form">
                        @csrf
                    </form>
        </li>
      <li class="nav-item">
...
<!-- Sidebar user panel (optional) -->
    <div class="  pb-3 mb-3 d-flex" style="background-color:rgb(212, 219, 219)">
        <div class="image img">
            @if (Auth::guard('specialist')->user()->image != "")
             <img src="{{ asset('/storage/images/'.Auth::guard('specialist')->user()->image )}}" height="60" width="60" class="img-circle elevation-2 ml-2 mt-1" alt="User Image">
            @else
        ...
        <div class="info ml-2 ">
            ...
            <div class="alert alert-dismissible fade show
                ...
                <form class="" action="{{ route('specialist.edit_profile_image') }}" method="POST" enctype="multipart/form-data">
                        @csrf
        ...
        <div class="col-5 ml-1 h-25 shadow  img" style="background-color:#00dfff; border-radius: 12px 0 0 12px; cursor: pointer; ">
    ...
    --}}
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column rounded" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item" >
            <a href="{{ route('specialist.dashboard') }}" class="nav-link text-white">
          ...
          <li class="nav-item">
            <a href="#"    class="nav-link text-white"     data-toggle="modal" data-target="#EditModal" >
          ...
          <li class="nav-item">
                <a href="{{ route('specialist.logout') }}" class="nav-link text-white" onclick="event.preventDefault();document.getElementById('logout-form').submit();">
          ...
          <li class="nav-item">
            <a href="" class="nav-link text-white" data-toggle="modal" data-target="#PasswordModal">
