<div class="container-fluid  mh-100 " >
    ...
    <script>
        swal("Successful","{!! session('password_success') !!}","success",{
            button:"ok",
        });
    </script>
    ...
    {{--
     ...
     @endif
        ...
        <form  action="{{ route('specialist.specialist_login') }}" method="POST"
        class="mx-auto mt-4 form-group col-9  col-sm-4" autocomplete="off" >
            ...
            <div class="form-group form-row mt-n3 mt-sm-n1">
                ...
                <input type="email"  :value="old('email')" name="email" id=""
                    ...
                    placeholder="" aria-describedby="helpId" required autofocus>
            ...
            <div class="form-group form-row   ">
                ...
                <div class="col-7">
                    <a class=" ml-lg-4 mt-1 small" href="{{ route('specialist.register') }}">
