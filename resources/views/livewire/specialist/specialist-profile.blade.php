...
<div class="container-fluid  mh-100 " >
    ...
    <div class="row login ">
            <h1 class="font mx-auto">Edit Profile</h1>
            </div>
    </div>
    ...
    @endif
        ...
        <form  action="{{ route('specialist.specialist_register') }}" method="POST" class=" mx-auto mt-4 form-group col-9  col-sm-4" >
            ...
            <div class="form-group form-row mt-n3 mt-sm-n1 ">
                <label class=" col-md-3 col-lg-3 col-form-label">
                    Profession</label>
                <div class="select2-purple  col-md-9 col-sm-10">
                  <select class="select2 form-control form-control-sm  round col-md-9 col-sm-10"
                     name="category" data-placeholder="Select a Profession" data-dropdown-css-class="select2-purple" style="width: 100%;">
            ...
            <div class="form-group form-row mt-n3 mt-sm-n1 ">
                ...
                <div class="select2-purple  col-md-9 col-sm-10">
                  <select class="select2 form-control form-control-sm  round col-md-9 col-sm-10"
                   multiple="multiple"  name="speciality" data-placeholder="Select a Specialty" data-dropdown-css-class="select2-purple" style="width: 100%;">
                     @foreach($specialty as $specialties)
                         <option></option>
                         <option value="{{  $specialties->id }}">{{ $specialties->specialization}}</option>
                   @endforeach
                  </select>
                </div>
              </div>
